...
class Menu:
    def __init__(self):
        self.TITLETEXT = simplegui.load_image(
            "https://raw.githubusercontent.com/python-pros-p9/stealth-game/master/images/menutext.png")
        ...
        self.BUTTON_START = simplegui.load_image(
            "https://raw.githubusercontent.com/python-pros-p9/stealth-game/master/images/start_button.png")
        self.BUTTON_CENTRE = (self.BUTTON_START.get_width() / 2, self.BUTTON_START.get_height() / 2)
        self.BUTTON_DIMS = (self.BUTTON_START.get_width(), self.BUTTON_START.get_height())
        self.BUTTON_SIZE = (240, 80)
        self.BUTTON_HALFSIZE =  (self.BUTTON_SIZE[0]/2,self.BUTTON_SIZE[1]/2)
        self.BUTTON_START_MAIN_POS = (CANVAS_DIMS[0] / 3, 400)
        
        self.BUTTON_HELP = simplegui.load_image(
            "https://raw.githubusercontent.com/python-pros-p9/stealth-game/master/images/help_button.png")
        ...
        self.BUTTON_SCORES = simplegui.load_image(
            "https://raw.githubusercontent.com/python-pros-p9/stealth-game/master/images/score_button.png")
        self.BUTTON_SCORES_POS = (CANVAS_DIMS[0] / 2, 500)
        
        self.BUTTON_MAINMENU = simplegui.load_image(
            "https://raw.githubusercontent.com/python-pros-p9/stealth-game/master/images/menu_button.png")
        ...
        self.BUTTON_RESUME = simplegui.load_image(
            "https://raw.githubusercontent.com/python-pros-p9/stealth-game/master/images/resume_button.png")
        self.BUTTON_RESUME_POS = (CANVAS_DIMS[0]/2,(CANVAS_DIMS[1]/5)*2)       
        
        self.END = simplegui.load_image(
            "https://raw.githubusercontent.com/python-pros-p9/stealth-game/master/images/gameover.png")
        
        self.WIN = simplegui.load_image(
            "https://raw.githubusercontent.com/python-pros-p9/stealth-game/master/images/winscreen.png")
